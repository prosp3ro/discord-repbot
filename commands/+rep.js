...
exports.run = async (client, message, args) => {
    ...
    // Message sent in 'reputation' channel.
        ...
        if (!args[1]) return message.channel.send(`You must provide the reason for adding the reputation to the user! <@${message.author.id}>`).then(m => m.delete(2000))
